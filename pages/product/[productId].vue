            ...
            <div class="pt-6">
                ...
                <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
                    <div class="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
                        <img :src=product.images[0] alt="product" class="h-full w-full object-cover object-center" />
                    </div>
                    <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
                        <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
                            <img :src=product.images[1] alt="product" class="h-full w-full object-cover object-center" />
                        </div>
                        <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
                            <img :src=product.images[2] alt="product" class="h-full w-full object-cover object-center" />
                        </div>
                    </div>
                </div>
...
const products = [
    {
        "id": 1,
        "images": [
            "https://cdn.discordapp.com/attachments/399896332187336704/1205883046193274950/placeholder.jpg?ex=65d9fd1a&is=65c7881a&hm=83b0f04496326fd0c68c67d6f78bf00205555c3cd9c00b17b705969b753e2db2&",
            "https://cdn.discordapp.com/attachments/399896332187336704/1205883046193274950/placeholder.jpg?ex=65d9fd1a&is=65c7881a&hm=83b0f04496326fd0c68c67d6f78bf00205555c3cd9c00b17b705969b753e2db2&",
            "https://cdn.discordapp.com/attachments/399896332187336704/1205883046193274950/placeholder.jpg?ex=65d9fd1a&is=65c7881a&hm=83b0f04496326fd0c68c67d6f78bf00205555c3cd9c00b17b705969b753e2db2&"
        ],
        "name": "RX-78-2 Gundam",
...
const product = computed(() => {
    return products.find((item) => item.id == route.params.productId)
})
